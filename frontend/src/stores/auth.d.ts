...
export declare const useAuthStore: import("pinia").StoreDefinition<"auth", Pick<{
    ...
    getCurrentUserStats: () => Promise<UserWithStats>;
    ...
    clearAuth: () => void;
    refreshToken: () => Promise<void>;
}, "initializeAuth" | "login" | "adminLogin" | "register" | "logout" | "getCurrentUser" | "getCurrentUserStats" | "setAuth" | "clearAuth" | "refreshToken">>;
export {};
